...
% upstream_sha256: 3a8521817164778613f93dd40cff2dda158bd885b4dc26b5b3ab82102343c58d
...
% ----------------------------------------------------------------
\chapter[Continuous Random Vectors]{Multiple Continuous Random Variables}
...
\begin{example}
% notation normalized 2026-07-05 (draft review, 5:19): the outcome's
% coordinates read (x, y), matching the example's own CDF variables below;
% upstream ../chapters/random_vectors.tex:435-436 still uses
% (\omega_1, \omega_2).
Consider a random experiment where an outcome $(x, y)$ is selected at random from the unit square.
Let $X = x$, $Y = y$ and $W = x + y$.
