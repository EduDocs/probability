...
% upstream_sha256: 08596169ec9f69266a63686a53f27be6bc683cab6a53925b405bc86f8d2b8626
...
\draw[very thick, ->, >=stealth'] (4.6,0.866) -- (5.6,0.866) node[midway, above] {$\frac{6}{10}$};

\shade[draw=black, ball color=green, circular drop shadow] (6.6,0.866) circle (4mm);
\shade[fill=white, fill opacity=0.3] (6.6,0.866) circle (4mm) node[fill opacity=1]{g};
...
\draw[very thick, ->, >=stealth'] (4.6,3.866) -- (5.6,3.866) node[midway, above] {$\frac{7}{11}$};

\shade[draw=black, ball color=green, circular drop shadow] (6.6,3.866) circle (4mm);
\shade[fill=white, fill opacity=0.3] (6.6,3.866) circle (4mm) node[fill opacity=1]{g};
...
\draw[very thick, ->, >=stealth'] (4.6,6.866) -- (5.6,6.866) node[midway, above] {$\frac{8}{12}$};
