...
\begin{figure}[htb!]
\begin{center}
\includegraphics[height=3.675cm]{figures/conditional_probability/condevent}
...
\begin{example}
A fair coin is tossed repeatedly until heads is observed.
...
\begin{example}
An urn contains eight green balls and four gray balls.
Three balls are drawn from this urn without replacement.
We wish to compute the probability that all three balls are green.
The probability of drawing a green ball the first time is equal to $8/12$.
The probability of drawing a green ball the second time given that the first ball is green is $7/11$.
Finally, the probability of drawing a green ball the third time given that the first two balls are green is $6/10$.
Using \eqref{equation:SimultaneousEvents}, we can compute the probability of drawing three green balls as
\begin{equation*}
\Pr (ggg)
...
\begin{footnotesize}
\begin{tikzpicture}
\shade[draw=black, ball color=gray, circular drop shadow] (0.9,1.732) circle (4mm);
\shade[fill=white, fill opacity=0.3] (0.9,1.732) circle (4mm) node[fill opacity=1]{};

\shade[draw=black, ball color=green, circular drop shadow] (0.45,0.866) circle (4mm);
\shade[fill=white, fill opacity=0.3] (0.45,0.866) circle (4mm) node[fill opacity=1]{g};
\shade[draw=black, ball color=green, circular drop shadow] (1.35,0.866) circle (4mm);
\shade[fill=white, fill opacity=0.3] (1.35,0.866) circle (4mm) node[fill opacity=1]{g};
\shade[draw=black, ball color=gray, circular drop shadow] (2.25,0.866) circle (4mm);
\shade[fill=white, fill opacity=0.3] (2.25,0.866) circle (4mm) node[fill opacity=1]{};
\shade[draw=black, ball color=green, circular drop shadow] (3.15,0.866) circle (4mm);
\shade[fill=white, fill opacity=0.3] (3.15,0.866) circle (4mm) node[fill opacity=1]{g};

\shade[draw=black, ball color=green, circular drop shadow] (0,0) circle (4mm);
\shade[fill=white, fill opacity=0.3] (0,0) circle (4mm) node[fill opacity=1]{g};
\shade[draw=black, ball color=gray, circular drop shadow] (0.9,0) circle (4mm);
\shade[fill=white, fill opacity=0.3] (0.9,0) circle (4mm) node[fill opacity=1]{};
\shade[draw=black, ball color=green, circular drop shadow] (1.8,0) circle (4mm);
\shade[fill=white, fill opacity=0.3] (1.8,0) circle (4mm) node[fill opacity=1]{g};
\shade[draw=black, ball color=green, circular drop shadow] (2.7,0) circle (4mm);
\shade[fill=white, fill opacity=0.3] (2.7,0) circle (4mm) node[fill opacity=1]{g};
\shade[draw=black, ball color=gray, circular drop shadow] (3.6,0) circle (4mm);
\shade[fill=white, fill opacity=0.3] (3.6,0) circle (4mm) node[fill opacity=1]{};

\draw[very thick, ->, >=stealth'] (4.6,0.866) -- (6.6,0.866) node[midway, above] {$\frac{6}{10}$} node[midway, below] {third draw};

\shade[draw=black, ball color=green, circular drop shadow] (7.6,0.866) circle (4mm);
\shade[fill=white, fill opacity=0.3] (7.6,0.866) circle (4mm) node[fill opacity=1]{g};
\shade[draw=black, ball color=green, circular drop shadow] (8.6,0.866) circle (4mm);
\shade[fill=white, fill opacity=0.3] (8.6,0.866) circle (4mm) node[fill opacity=1]{g};
\draw[draw=black] (9.6,0.866) circle (4mm);

\shade[draw=black, ball color=gray, circular drop shadow] (0.9,4.732) circle (4mm);
\shade[fill=white, fill opacity=0.3] (0.9,4.732) circle (4mm) node[fill opacity=1]{};
\shade[draw=black, ball color=green, circular drop shadow] (1.8,4.732) circle (4mm);
\shade[fill=white, fill opacity=0.3] (1.8,4.732) circle (4mm) node[fill opacity=1]{g};

\shade[draw=black, ball color=green, circular drop shadow] (0.45,3.866) circle (4mm);
\shade[fill=white, fill opacity=0.3] (0.45,3.866) circle (4mm) node[fill opacity=1]{g};
\shade[draw=black, ball color=green, circular drop shadow] (1.35,3.866) circle (4mm);
\shade[fill=white, fill opacity=0.3] (1.35,3.866) circle (4mm) node[fill opacity=1]{g};
\shade[draw=black, ball color=gray, circular drop shadow] (2.25,3.866) circle (4mm);
\shade[fill=white, fill opacity=0.3] (2.25,3.866) circle (4mm) node[fill opacity=1]{};
\shade[draw=black, ball color=green, circular drop shadow] (3.15,3.866) circle (4mm);
\shade[fill=white, fill opacity=0.3] (3.15,3.866) circle (4mm) node[fill opacity=1]{g};

\shade[draw=black, ball color=green, circular drop shadow] (0,3) circle (4mm);
\shade[fill=white, fill opacity=0.3] (0,3) circle (4mm) node[fill opacity=1]{g};
\shade[draw=black, ball color=gray, circular drop shadow] (0.9,3) circle (4mm);
\shade[fill=white, fill opacity=0.3] (0.9,3) circle (4mm) node[fill opacity=1]{};
\shade[draw=black, ball color=green, circular drop shadow] (1.8,3) circle (4mm);
\shade[fill=white, fill opacity=0.3] (1.8,3) circle (4mm) node[fill opacity=1]{g};
\shade[draw=black, ball color=green, circular drop shadow] (2.7,3) circle (4mm);
\shade[fill=white, fill opacity=0.3] (2.7,3) circle (4mm) node[fill opacity=1]{g};
\shade[draw=black, ball color=gray, circular drop shadow] (3.6,3) circle (4mm);
\shade[fill=white, fill opacity=0.3] (3.6,3) circle (4mm) node[fill opacity=1]{};

\draw[very thick, ->, >=stealth'] (4.6,3.866) -- (6.6,3.866) node[midway, above] {$\frac{7}{11}$} node[midway, below] {second draw};

\shade[draw=black, ball color=green, circular drop shadow] (7.6,3.866) circle (4mm);
\shade[fill=white, fill opacity=0.3] (7.6,3.866) circle (4mm) node[fill opacity=1]{g};
\draw[draw=black] (8.6,3.866) circle (4mm);
\draw[draw=black] (9.6,3.866) circle (4mm);

\shade[draw=black, ball color=gray, circular drop shadow] (0.9,7.732) circle (4mm);
\shade[fill=white, fill opacity=0.3] (0.9,7.732) circle (4mm) node[fill opacity=1]{};
\shade[draw=black, ball color=green, circular drop shadow] (1.8,7.732) circle (4mm);
\shade[fill=white, fill opacity=0.3] (1.8,7.732) circle (4mm) node[fill opacity=1]{g};
\shade[draw=black, ball color=green, circular drop shadow] (2.7,7.732) circle (4mm);
\shade[fill=white, fill opacity=0.3] (2.7,7.732) circle (4mm) node[fill opacity=1]{g};

\shade[draw=black, ball color=green, circular drop shadow] (0.45,6.866) circle (4mm);
\shade[fill=white, fill opacity=0.3] (0.45,6.866) circle (4mm) node[fill opacity=1]{g};
\shade[draw=black, ball color=green, circular drop shadow] (1.35,6.866) circle (4mm);
\shade[fill=white, fill opacity=0.3] (1.35,6.866) circle (4mm) node[fill opacity=1]{g};
\shade[draw=black, ball color=gray, circular drop shadow] (2.25,6.866) circle (4mm);
\shade[fill=white, fill opacity=0.3] (2.25,6.866) circle (4mm) node[fill opacity=1]{};
\shade[draw=black, ball color=green, circular drop shadow] (3.15,6.866) circle (4mm);
\shade[fill=white, fill opacity=0.3] (3.15,6.866) circle (4mm) node[fill opacity=1]{g};

\shade[draw=black, ball color=green, circular drop shadow] (0,6) circle (4mm);
\shade[fill=white, fill opacity=0.3] (0,6) circle (4mm) node[fill opacity=1]{g};
\shade[draw=black, ball color=gray, circular drop shadow] (0.9,6) circle (4mm);
\shade[fill=white, fill opacity=0.3] (0.9,6) circle (4mm) node[fill opacity=1]{};
\shade[draw=black, ball color=green, circular drop shadow] (1.8,6) circle (4mm);
\shade[fill=white, fill opacity=0.3] (1.8,6) circle (4mm) node[fill opacity=1]{g};
\shade[draw=black, ball color=green, circular drop shadow] (2.7,6) circle (4mm);
\shade[fill=white, fill opacity=0.3] (2.7,6) circle (4mm) node[fill opacity=1]{g};
\shade[draw=black, ball color=gray, circular drop shadow] (3.6,6) circle (4mm);
\shade[fill=white, fill opacity=0.3] (3.6,6) circle (4mm) node[fill opacity=1]{};

\draw[very thick, ->, >=stealth'] (4.6,6.866) -- (6.6,6.866) node[midway, above] {$\frac{8}{12}$} node[midway, below] {first draw};

\draw[draw=black] (7.6,6.866) circle (4mm);
\draw[draw=black] (8.6,6.866) circle (4mm);
\draw[draw=black] (9.6,6.866) circle (4mm);
\end{tikzpicture}
\end{footnotesize}
...
\end{equation*}
Visually, a partition divides an entire set into disjoint subsets, as exemplified in Figure~\ref{figure:SetPartition2}.
...
\end{split}
\end{equation*}
where the third equality follows from the third axiom of probability.
\end{proof}
...
On the other hand, if a ball is drawn from the second urn, the probability that it is green reduces to $3/12$.
...
The quantities that appear in Bayes' rule carry standard names.
The unconditional probability $\Pr (A_i)$ is the \emph{prior} probability of $A_i$, the value held before $B$ is observed.\index{Prior probability}
The conditional probability $\Pr (A_i | B)$ is the corresponding \emph{posterior} probability, the value that applies once $B$ has been taken into account.\index{Posterior probability}
The factor $\Pr (B | A_i)$, viewed as a function of the conditioning event, is called the \emph{likelihood}.\index{Likelihood}
Bayes' rule is, in this language, a recipe for turning prior probabilities into posterior probabilities in the light of new evidence.

The rule also guards against a pervasive confusion.
The conditional probabilities $\Pr (A | B)$ and $\Pr (B | A)$ answer different questions, and they are generally not equal;
treating one as a substitute for the other is a reasoning error known as \emph{confusion of the inverse}.\index{Confusion of the inverse}
The mistake carries real stakes in a courtroom, where the probability of observing the evidence in an innocent person may be small, yet it is wrongly read as the probability that an accused person is innocent given the evidence.
This particular form of the error is often called the \emph{prosecutor's fallacy}.\index{Prosecutor's fallacy}
Bayes' rule makes the relationship between the two conditional probabilities precise, and it shows that they coincide only in special circumstances.
...
This last result is frequently met with disbelief, and the surprise itself points to a widespread reasoning error.
Confronted with a test that is correct ninety-five percent of the time, intuition tends to fix on this figure and to disregard how rare the disease is to begin with.
Neglecting the underlying prevalence of a condition when weighing such evidence is known as the \emph{base-rate fallacy}.\index{Base-rate fallacy}
Because only one person in a hundred carries the disease, the modest fraction of false positives drawn from the vast healthy majority outnumbers the true positives drawn from the few who are ill;
the prior probability $\Pr (D)$ is every bit as essential to the answer as the accuracy of the test.

\begin{example}[Monty Hall Problem] \index{Monty Hall problem}
A game show presents a contestant with three closed doors.
A car sits behind one door and a goat stands behind each of the other two;
the car is equally likely to be in any of the three positions.
The contestant selects a door, say door one, but it stays closed for the moment.
The host, who knows where the car is, then opens one of the two remaining doors, always revealing a goat, and offers the contestant the chance to switch to the other unopened door.
We wish to determine whether switching improves the contestant's chances of winning the car.

Let $C_i$ denote the event that the car is behind door $i$, so that $\Pr (C_1) = \Pr (C_2) = \Pr (C_3) = 1/3$.
Suppose the contestant has picked door one and the host responds by opening door three, an event we denote by $H$.
To decide whether to switch, we compare $\Pr (C_1 | H)$, the probability of winning by staying, against $\Pr (C_2 | H)$, the probability of winning by switching.

The crux of the problem is the likelihood assigned to the host's action under each hypothesis.
If the car is behind door one, the host is free to open either remaining door, and we assume an unbiased choice, so that $\Pr (H | C_1) = 1/2$.
If the car is behind door two, the host can open neither the contestant's door nor the door concealing the car, and is thus forced to open door three, giving $\Pr (H | C_2) = 1$.
If the car is behind door three, the host will not reveal it, so that $\Pr (H | C_3) = 0$.
By the total probability theorem, the probability that the host opens door three is
\begin{equation*}
\Pr (H)
...
= \frac{1}{2} .
\end{equation*}
Applying Bayes' rule, the posterior probabilities of the two remaining hypotheses are
\begin{align*}
\Pr (C_1 | H) &= \frac{ \Pr (C_1) \Pr (H | C_1) }{ \Pr (H) }
= \frac{ (1/3)(1/2) }{ 1/2 } = \frac{1}{3} , \\
\Pr (C_2 | H) &= \frac{ \Pr (C_2) \Pr (H | C_2) }{ \Pr (H) }
= \frac{ (1/3)(1) }{ 1/2 } = \frac{2}{3} .
\end{align*}
Switching doubles the contestant's chance of winning, from one third to two thirds.
The opened door is far from a neutral event;
because the host is constrained to avoid both the contestant's door and the car, opening door three transfers its share of the probability onto door two rather than spreading it evenly.
\end{example}
...
= \Pr (A).
\end{equation*}
That is, the prior probability of event $A$ is identical to the posterior probability of $A$ given $B$.
...
A common misconception conflates independence with mutual exclusivity, leading one to assume that two disjoint events must be independent.\index{Independence!versus mutual exclusivity}
...
Independence also dispels a stubborn intuition about repeated trials.
When successive trials are independent, the outcomes already observed carry no information about those still to come;
a fair coin that has just landed heads ten times in a row is no more likely to show tails on the next toss than it ever was.
The belief that a run of one outcome makes the opposite outcome ``due'' is the \emph{gambler's fallacy}.\index{Gambler's fallacy}
It mistakes the long-run balancing of frequencies, which independence does predict, for a corrective force acting on individual trials, which independence explicitly forbids.
...
Finally, let $C$ be the event that the two tosses show distinct sides.
