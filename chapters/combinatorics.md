...
- Stirling's formula as an asymptotic approximation to n! (optional/starred).
- k-permutations: ordered selections of k from n, P(n,k).
- Combinations: unordered selections; binomial coefficient and Pascal-style identities.
